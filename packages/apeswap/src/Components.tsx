    ...
    <>
      ...
      <Box sx={{ position: "relative" }}>
        <Components.Base.SmallLabel
          style={{
            position: isSrcToken ? "inherit" : "absolute",
            top: isSrcToken ? "" : "-25px",
            marginBottom: isSrcToken ? "5px" : "",
          }}
          className="twap-token-panel-title"
        >
          {isSrcToken ? translations.from : `${translations.to}`}
        </Components.Base.SmallLabel>
...
export const ChangeTokensOrder = () => {
  return (
    <Box my={1} sx={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center" }}>
