...
export const darkModeStylesConfig: StylesConfig = {
  ...
  progressBarColor: "linear-gradient(180deg,#FFB300,#004ce6)",
  ...
  selectTokenBackground: "linear-gradient(180deg,#FFB300,#004ce6)",
  selectTokenTextColor: "white",
  selectedTokenBackground: "#424242",
...
export const lightModeStylesConfig: StylesConfig = {
  ...
  spinnerColor: "white",
  containerBackground: "rgb(16, 23, 38)",
  cardBackground: "#F1EAD4",
  wrapperBackground: "#F9F4E7",
  progressBarColor: "linear-gradient(180deg,#FFB300,#004ce6)",
  progressBarTrackColor: "#c7cad9",
  orderHistorySelectedTabBackground: "#134DC8",
  orderHistoryTabColor: "white",
...
export const configureStyles = (isProMode?: boolean, isDarkMode?: boolean) => {
  ...
  return {
    ".twap-trade-size": {
      ...
      ".MuiSlider-track": {
        color: isDarkMode ? "#A3A8B8" : "#656565",
      },
    },
    ...
    ".twap-limit-price-input": {
      background: isDarkMode ? "#212121" : "#F9F4E7",
    ...
    ".twap-token-select": {
      ...
      background: `${isDarkMode ? styles.selectedTokenBackground : "#EADFC7"}!important`,
      ".twap-token-name": {
        fontWeight: "500!important",
    ...
    ".twap-token-not-selected": {
      ...
      backgroundImage: styles.selectedTokenBackground,
      p: {
        fontSize: 16,
      },
    },
    ...
    ".twap-slider": {
      ...
      "& .MuiSlider-thumb": {
        boxShadow: "none!important",
        background: isDarkMode ? "#D9D9D9" : "#656565",
        width: 13,
        height: 13,
      },
    },
    ...
    ".twap-order": {
      ...
      "& .MuiLinearProgress-bar": {
        ...
        background: isDarkMode ? "#FFB300" : "#FFB300",
      },
    },
    ".twap-chunks-size": {
      ".twap-label": {
    ...
    ".twap-orders": {
      paddingBottom: 24,
      background: isDarkMode ? "#212121" : "#F9F4EA",
      fontWeight: 500,
      color: styles.textColor,
      "*": {
        fontWeight: "inherit!important",
