...
import { Orders, TWAP, Limit, QuickSwapTWAPProps, QuickSwapOrdersProps } from "@orbs-network/twap-ui-apeswap";
...
const tempConfig = Configs.QuickSwap;

const config = { ...tempConfig };
config.partner = "ApeSwap";

const nativeTokenLogo = "https://s2.coinmarketcap.com/static/img/coins/64x64/8497.png";
...
const logo = "https://s2.coinmarketcap.com/static/img/coins/64x64/8497.png";
const DappComponent = () => {
